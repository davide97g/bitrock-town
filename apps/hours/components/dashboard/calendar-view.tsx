...
import { getTimeEntries, getLeaveRequests } from "@/lib/mock-data"
              ...
              return (
                ...
                >
                    ...
                    {events.length > 0 && (
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            <DialogTitle>
                              Eventi del {day} {getMonthName(currentDate)} {currentDate.getFullYear()}
                            </DialogTitle>
                            <DialogDescription>Dettaglio degli eventi per questa giornata</DialogDescription>
                          </DialogHeader>
                          <div className="space-y-4 mt-4">
                            {events.map((event, eventIndex) => (
                              <div key={eventIndex} className="border rounded-md p-3">
                                ...
                                {event.hours && <p className="text-sm mb-1">Ore: {event.hours}</p>}
                  ...
                  <div className="mt-1 space-y-1">
                      ...
                      <TooltipProvider key={eventIndex}>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              {event.type === "work" ? `${event.hours}h` : getEventTypeLabel(event.type)}
                            </div>
                          </TooltipTrigger>
                          <TooltipContent>
                    ...
                    {events.length > 2 && (
                      <div className="text-xs text-muted-foreground">+{events.length - 2} altri</div>
                    )}
                  </div>
                </div>
              )
